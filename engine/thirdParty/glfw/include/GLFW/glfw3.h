 ...
 *  any other thread.
 *
 *  @remark @macos The OS only supports forward-compatible rendering profile contexts
 ...
 *
 *  This function returns the address of the specified Vulkan rendering or extension
