...
// IMGUI_API is used for rendering imgui functions, IMGUI_IMPL_API is used for the default backends files (imgui_impl_xxx.h)
...
enum ImGuiConfigFlags_
{
    ...
    // User storage (to allow your backend/engine to communicate to code that may be shared between multiple projects. Those flags are not used by rendering Dear ImGui)
