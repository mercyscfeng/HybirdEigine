...
struct ImGuiContext
{
    ...
    ImGuiID                 DebugHookIdInfo;                    // Will call rendering hooks: DebugHookIdInfo() from GetID functions, used by Stack Tool [next HoveredId/ActiveId to not pull in an extra cache-line]
